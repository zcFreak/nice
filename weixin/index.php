...
{  
    ...
    {  
        ...
        {  
            case "subscribe":  
                $content = "欢迎来到水果派对，千万果粉的推荐，好吃错不了！\n";  
...
//http://www.92deyang.com/1502phpf/chen/wx_sample.php?security_verify_data=313336362c373638  
...
//接收事件消息  
    ...
    {  
        ...
        {  
            case "subscribe":  
                $content = array();  
                $content[] = array("Title"=>"千万果粉的推荐，好吃错不了！",  "Description"=>"单图文内容",  
                    "PicUrl"=>"http://pic34.photophoto.cn/20150321/0020033086729191_b.jpg",  
                    "Url" =>"http://www.360doc.com/content/14/0910/15/3972368_408421452.shtml");  
                break;  
            case "unsubscribe":  
                $content = "取消关注";  
                break;  
...
//自动回复模式  
        if (strstr($keyword, "文本")){  
            ...
            $content = array();  
            $content = array("Title"=>"最炫民族风", "Description"=>"歌手：凤凰传奇", "MusicUrl"=>"http://mascot-music.stor.sinaapp.com/zxmzf.mp3", "HQMusicUrl"=>"http://mascot-music.stor.sinaapp.com/zxmzf.mp3");  
        }else if(strstr($keyword, "我爱你")){  
            $content = array();  
            $content[] = array("Title"=>"爱爱大头鬼", "Description"=>"","Url" =>"http://www.92deyang.com/1502phpf/chen/c.php","PicUrl"=>"http://www.92deyang.com/1502phpf/chen/30.jpg");  
